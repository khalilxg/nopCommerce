...
public partial class CheckoutController : BasePublicController
{
    ...
    /// </returns>
    protected virtual async Task<DateTime?> ParseSelectedShippingMethodDeliveryDateAsync(ShippingOption shippingOption, List<ShippingOption> shippingOptions, IFormCollection form)
    {
